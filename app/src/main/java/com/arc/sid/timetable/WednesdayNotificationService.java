...
public class WednesdayNotificationService extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equalsIgnoreCase("FirstPeriod")) {
            ...
            builder.setContentIntent(PendingIntent.getActivity(context, 100, new Intent(context, Wednesday.class), 0));
        ...
        if (intent.getAction().equalsIgnoreCase("SecondPeriod")) {
            ...
            builder.setContentIntent(PendingIntent.getActivity(context, 101, new Intent(context, Wednesday.class), 0));
            Notification notification = builder.build();
        ...
        if (intent.getAction().equalsIgnoreCase("ThirdPeriod")) {
            builder.setContentText("Digital Signal Processing");
            builder.setContentIntent(PendingIntent.getActivity(context, 102, new Intent(context, Wednesday.class), 0));
            Notification notification = builder.build();
        ...
        if (intent.getAction().equalsIgnoreCase("FourthPeriod")) {
            builder.setContentText("Digital Signal Processing");
            builder.setContentIntent(PendingIntent.getActivity(context, 103, new Intent(context, Wednesday.class), 0));
            Notification notification = builder.build();
        ...
        if (intent.getAction().equalsIgnoreCase("FifthPeriod")) {
            builder.setContentText("Digital Signal Processing");
            builder.setContentIntent(PendingIntent.getActivity(context, 104, new Intent(context, Wednesday.class), 0));
            Notification notification = builder.build();
        ...
        if (intent.getAction().equalsIgnoreCase("SixthPeriod")) {
            builder.setContentText("Digital Signal Processing");
            builder.setContentIntent(PendingIntent.getActivity(context, 105, new Intent(context, Wednesday.class), 0));
            Notification notification = builder.build();
